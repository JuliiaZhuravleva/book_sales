...
Для работы с программой требуется создать базу данных PostgreSQL и внести информацию о базе данных в переменные окружения:
- **DBNAME** - название БД
- **DBUSER** - имя пользователя
- **DBPASS** - пароль

При желании можно использовать другую БД. Для этого в файле main.py, где задается переменная DSN (71 строка) заменить postgresql на требуемую БД.

## Запуск программы
При запуске программа заполнит базу данными из файла /fixtures/tests_data.json. 
Затем запросит id или название издателя, для которого требуется найти данные о продажах.
Для проверки можно ввести идентификатор 1.
